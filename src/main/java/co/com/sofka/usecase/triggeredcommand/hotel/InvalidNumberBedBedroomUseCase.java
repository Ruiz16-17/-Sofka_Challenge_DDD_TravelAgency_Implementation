...
public class InvalidNumberBedBedroomUseCase extends UseCase<RequestCommand<AddBedroom>, ResponseEvents> {
    ...
    public void executeUseCase(RequestCommand<AddBedroom> addBedroomRequestCommand) {
        ...
        if(command.getNumberBedBedroom().value() < 1){
            hotel.updateNumberBedBedroom(command.getBedroomId(), new NumberBedBedroom(1));
